...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative h-full flex flex-col justify-center items-center text-center px-6 opacity-0 animate-fade-in">
        <h1 
          ref={titleRef} 
      ...
      {/* Scroll Indicator */}
      <div 
        className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center cursor-pointer opacity-0 animate-fade-in animation-delay-1000"
