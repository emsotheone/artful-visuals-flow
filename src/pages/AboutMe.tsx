...
const AboutMe = () => {
  ...
  return (
    <div className={`min-h-screen bg-background text-foreground overflow-x-hidden transition-opacity duration-300 ${contentLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {/* Equipment Section - Updated with better contrast and colors */}
      <section className="py-20 px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/40 to-black/60 light-mode:from-white/70 light-mode:via-white/60 light-mode:to-white/70"></div>
        </div>
        
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <span className="font-medium text-white/70 uppercase tracking-widest text-sm light-mode:text-black/70">Equipment</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mt-3 mb-4 uppercase">
              MEINE WERKZEUGE
            </h2>
            <p className="text-white/90 max-w-2xl mx-auto light-mode:text-black/90">
              Qualität beginnt mit dem richtigen Equipment. Das ist meine Ausrüstung für professionelle Ergebnisse.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/20 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover-lift light-mode:bg-white/80 light-mode:border-black/10 light-mode:shadow-md transition-all duration-300">
